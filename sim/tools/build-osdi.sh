...
#
# Copied structurally from sg13g2-bandgap/sim/tools/build-osdi.sh and
# sg13g2-opamp/sim/tools/build-osdi.sh (same PDK, same pinned toolchain);
# the only repo-specific change is the SG13G2_TOOLS_CACHE default directory
# name below.
#
...
CACHE_DIR="${SG13G2_TOOLS_CACHE:-${HOME}/.cache/sg13g2-ldo}"
mkdir -p "${CACHE_DIR}"
